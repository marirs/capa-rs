...
use crate::disassembler::BinaryInfo;
use crate::result::Result;
use std::convert::TryInto;

#[derive(Debug, Clone)]
struct CommonPlagues {
    cp: std::collections::HashMap<
        u32,
        std::collections::HashMap<u32, std::collections::HashMap<Vec<u8>, u32>>,
    >,
}
...
pub struct FunctionCandidate {
    ...
    pub call_ref_sources: std::collections::HashSet<u64>,
    finished: bool,
    is_symbol: bool,
...
impl FunctionCandidate {
    pub fn new(bi: &BinaryInfo, addr: u64) -> Result<FunctionCandidate> {
        ...
        let mut fc = FunctionCandidate {
            ...
            lang_spec: None,
            call_ref_sources: std::collections::HashSet::new(),
            finished: false,
            is_symbol: false,
