...
pub struct MnemonicTfIdf {
    bitness: u32,
    idf: std::collections::HashMap<&'static str, f32>,
}
...
impl MnemonicTfIdf {
    ...
    pub fn get_tfidf_from_blocks(
        &self,
        blocks: &std::collections::HashMap<u64, Vec<(u64, String, String, Option<String>)>>,
    ) -> Result<f32> {
    ...
    pub fn tfidf(&self, term_counts: &std::collections::HashMap<String, u32>) -> Result<f32> {
        let mut score = 0.0;
