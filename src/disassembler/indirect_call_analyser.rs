...
//            current_calling_addr: 0
    ...
    pub fn resolve_register_calls(
        ...
        analysis_state: &mut crate::disassembler::FunctionAnalysisState,
        block_depth: i32,
    ) -> Result<(
        Vec<(u64, crate::disassembler::label_providers::ApiEntry)>,
        Vec<(u64, u64)>,
    )> {
    ...
    pub fn search_block(
        &self,
        analysis_state: &crate::disassembler::FunctionAnalysisState,
        address: &u64,
    ...
    pub fn process_block(
        ...
        registers: &mut std::collections::HashMap<String, u64>,
        register_name: &mut String,
        processed: &mut std::collections::HashSet<
            Vec<(u64, u32, Option<String>, Option<String>, Vec<u8>)>,
        >,
        depth: i32,
        current_calling_addr: u64,
        disassembler: &crate::disassembler::Disassembler,
        api_e: &mut Vec<(u64, crate::disassembler::label_providers::ApiEntry)>,
