use crate::disassembler::function::Function;
use crate::disassembler::statistics::DisassemblyStatistics;
...
pub struct DisassemblyReport {
    ...
    pub architecture: crate::disassembler::Arch,
    pub base_addr: u64,
    binary_size: u64,
    binweight: u32,
    pub bitness: u32,
    ...
    functions: std::collections::HashMap<u64, Function>,
...
impl DisassemblyReport {
    ...
    pub fn get_functions(&self) -> Result<&std::collections::HashMap<u64, Function>> {
        Ok(&self.functions)
    }
