...
impl Instruction {
    ...
    pub fn get_data_refs(
        &self,
        report: &crate::disassembler::DisassemblyReport,
    ) -> Result<Vec<u64>> {
        let mut res = vec![];
        if ![
...
pub struct Function {
    ...
    pub bitness: u32,
    pub offset: u64,
    blocks: std::collections::HashMap<u64, Vec<Instruction>>,
    pub apirefs: std::collections::HashMap<u64, (Option<String>, Option<String>)>,
    pub blockrefs: std::collections::HashMap<u64, Vec<u64>>,
    pub inrefs: Vec<u64>,
    pub outrefs: std::collections::HashMap<u64, Vec<u64>>,
    pub binweight: u32,
...
impl Function {
    ...
    fn parse_blocks(
        disassembly: &crate::disassembler::DisassemblyResult,
        block_dict: &std::collections::HashMap<u64, Vec<(u64, String, String, Option<String>)>>,
    ) -> Result<std::collections::HashMap<u64, Vec<Instruction>>> {
    ...
    pub fn get_blocks(&self) -> Result<&std::collections::HashMap<u64, Vec<Instruction>>> {
        Ok(&self.blocks)
    }
